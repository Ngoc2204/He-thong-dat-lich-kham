...
<div class="container-fluid px-4 py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h2 class="fw-bold mb-1">Thêm bệnh nhân</h2>
      <p class="text-muted mb-0">Tạo hồ sơ bệnh nhân mới</p>
    </div>
  ...
  <div class="row">
    <div class="col-lg-8 col-xl-7">
      <form method="POST" action="{{ route('patients.store') }}" enctype="multipart/form-data" id="patientForm">
        @csrf
          ...
          <div class="card-body p-4">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <small class="text-muted d-block mt-2">Tuổi: <span id="ageDisplay">--</span></small>
              </div>
        ...
        <div class="d-flex gap-2 mb-4">
          ...
          <a href="{{ route('patients.index') }}" class="btn btn-outline-secondary btn-lg px-4 py-2">
      ...
      <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
        ...
        <div class="card-body p-4">
          ...
          <div class="text-center mb-4">
            ...
            <h5 class="fw-bold" id="previewName">--</h5>
            <span class="badge bg-info bg-opacity-10 text-info" id="previewAge">--</span>
          </div>
...
<script>
  ...
  removeImageBtn.addEventListener('click', () => {
    ...
    document.getElementById('avatarPreview').innerHTML = '<i class="bi bi-person fs-1 text-primary"></i>';
  });
