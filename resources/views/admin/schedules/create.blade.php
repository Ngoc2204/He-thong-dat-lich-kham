...
<div class="container-fluid px-4 py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h2 class="fw-bold mb-1">Thêm lịch làm việc</h2>
      <p class="text-muted mb-0">Tạo lịch làm việc hàng tuần cho bác sĩ</p>
    </div>
      ...
      <form method="POST" action="{{ route('schedules.store') }}">
        ...
        <div class="card border-0 shadow-sm mb-4">
          ...
          <div class="card-body p-4">
            <div class="mb-4">
              ...
              <div id="dentistPreview" class="mt-3 p-3 bg-light rounded d-none">
                <div class="d-flex align-items-center">
                  <img id="dentistAvatar" src="" class="rounded-circle me-3" style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
                    <div class="fw-semibold" id="dentistName"></div>
                    <small class="text-muted" id="dentistSpecialty"></small>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-2">
                ...
                <div class="col">
                  <input type="radio" 
                         ...
                         value="{{ $day['value'] }}"
                         {{ old('weekday', 1) == $day['value'] ? 'checked' : '' }}
                         required>
        ...
        <div class="d-flex gap-2 mb-4">
          <button type="submit" class="btn btn-primary btn-lg px-4 py-2">
            <i class="bi bi-check-circle me-2"></i>Lưu lịch làm việc
          </button>
      ...
      <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
        ...
        <div class="card-body p-4">
          <div class="text-center mb-4">
            ...
            <h5 class="fw-bold mb-1" id="previewDentist">Chọn bác sĩ</h5>
          ...
          <div class="mb-3">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 p-3 bg-light rounded">
              <span class="fs-4 fw-bold text-success" id="previewStart">09:00</span>
              <i class="bi bi-arrow-right-circle text-muted"></i>
              <span class="fs-4 fw-bold text-danger" id="previewEnd">17:00</span>
            </div>
          </div>
...
<script>
  ...
  // Update preview when dentist selected
  ...
  // Update preview when weekday selected
