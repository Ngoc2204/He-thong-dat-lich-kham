...
<div class="container-fluid px-4 py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h2 class="fw-bold mb-1">Thêm dịch vụ mới</h2>
      <p class="text-muted mb-0">Điền thông tin dịch vụ nha khoa vào form bên dưới</p>
    </div>
          ...
          <div class="card-body p-4">
            ...
            <div class="mb-3">
              ...
              <select class="form-select @error('category') is-invalid @enderror" name="category">
                ...
                <option value="Điều trị tổng quát" {{ old('category') == 'Điều trị tổng quát' ? 'selected' : '' }}>Điều trị tổng quát</option>
                <option value="Thẩm mỹ" {{ old('category') == 'Thẩm mỹ' ? 'selected' : '' }}>Thẩm mỹ</option>
                <option value="Chỉnh nha" {{ old('category') == 'Chỉnh nha' ? 'selected' : '' }}>Chỉnh nha</option>
                <option value="Phục hồi răng" {{ old('category') == 'Phục hồi răng' ? 'selected' : '' }}>Phục hồi răng</option>
                <option value="Nha chu" {{ old('category') == 'Nha chu' ? 'selected' : '' }}>Nha chu</option>
                <option value="Phẫu thuật" {{ old('category') == 'Phẫu thuật' ? 'selected' : '' }}>Phẫu thuật</option>
                <option value="Nội nha" {{ old('category') == 'Nội nha' ? 'selected' : '' }}>Nội nha</option>
                <option value="Implant" {{ old('category') == 'Implant' ? 'selected' : '' }}>Implant</option>
              </select>
              @error('category')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" 
                        name="description" 
                        rows="4"
                        placeholder="Mô tả chi tiết về dịch vụ, quy trình thực hiện, lợi ích...">{{ old('description') }}</textarea>
          ...
          <div class="card-body p-4">
            <div class="mb-3">
              ...
              <textarea class="form-control @error('notes') is-invalid @enderror" 
                        name="notes" 
                        rows="3"
                        placeholder="Ghi chú về lưu ý đặc biệt, chuẩn bị trước khi thực hiện...">{{ old('notes') }}</textarea>
      ...
      <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
        ...
        <div class="card-body p-4">
          <div class="text-center mb-3">
            ...
            <h5 class="fw-bold mb-1" id="previewName">Tên dịch vụ</h5>
            <span class="badge bg-info bg-opacity-10 text-info" id="previewCategory">Danh mục</span>
          </div>

          <div class="mb-3">
            <label class="text-muted small mb-1">Mô tả</label>
            <p class="small" id="previewDescription">Chưa có mô tả</p>
          </div>

          <div class="row mb-3">
            <div class="col-6">
              <label class="text-muted small mb-1">Giá</label>
              <p class="fw-bold text-success mb-0 fs-5" id="previewPrice">0đ</p>
            </div>
            <div class="col-6">
              <label class="text-muted small mb-1">Thời lượng</label>
              <p class="fw-bold mb-0" id="previewDuration">30 phút</p>
            </div>
          </div>
